          ...
          <GridCol span={{ md: 4, sm: 12 }}>
            <Stack gap="sm">
              ...
              <Text size="sm" c="dimmed" className="text-justify">
                ...
                ipsam, accusamus tempore veniam rerum obcaecati delectus dolores
                aut pariatur eos quasi! Perferendis, quas. Lorem ipsum dolor
                sit, amet consectetur adipisicing elit. Accusantium dolorem
                cumque magni culpa possimus quis iusto ipsam, accusamus tempore
                veniam rerum obcaecati delectus dolores aut pariatur eos quasi!
                Perferendis, quas.
              </Text>
              <Divider />
              <Group gap="xs">
